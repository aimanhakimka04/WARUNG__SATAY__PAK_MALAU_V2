...
header("location:index.php?page=z");
  				...
  				<div class="card-body">
  					<form id="login-form" >
  						<div class="form-group">
  							<label for="username" class="control-label"><span style="color:red;">*</span>Username</label>
						...
						<div class="form-group">
							...
							<a href="forgotpassadmin.php" class="">Forgot Your Password?</a>
	...
	$('#login-form').submit(function(e){
		...
		$('#login-form button[type="button"]').removeAttr('disabled').html('Login');
			...
			success:function(resp){
				if(resp == 1){
					location.href ='index.php?page=start';
				}
