...
<script>
	...
	$('#manage-category').submit(function(e){
		...
		$.ajax({
			...
			data: new FormData($(this)[0]), // convert form to object
		    cache: false,
		    contentType: false,
		    processData: false,
		    method: 'POST',
	...
	$('.delete_cat').click(function(){
		...
		_conf("Are you sure to delete this category?","delete_cat", [id]);
	});
		...
		$.ajax({
			...
			success:function(resp){
				if(resp==1){
					...
					alert("Cannot delete. Category is used by products.", 'error');
					end_load();
				}
			}
		});
